...
import passwordComparySync from "#root/helpers/passwordCompareSync";
...
const setupRoutes = (app: Express) => {
  ...
  app.post("/sessions", async (req, res, next) => {
    ...
    try {
      ...
      if (!passwordComparySync(req.body.password, user.passwordHash))
  ...
  app.get("/users/:userId", async (req, res, next) => {
    try {
      ...
      if (!user) return next(new Error("Invalid user ID! hehe"));
